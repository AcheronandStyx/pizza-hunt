...
function getPizza() {
  ...
  fetch(`/api/pizzas/${pizzaId}`)
    ...
    .catch((err) => {
      ...
      // he window history API exposes methods that let us control the state of the browser's session.
...
function handleNewCommentSubmit(event) {
  ...
  // Add fetch() POST functionality for creating a new comment into the handleNewCommentSubmit() function that you already started.
